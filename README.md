...
The orthopaedic practice in my hometown has to spend many hours negotiating and creating a fair call schedule for an entire year. While the usability is meant to be generic, the design was primarily tailored to them. The "call schedule" represents the doctor that is on-call during that day, and can be called in at anytime (even 1 AM for instance) during that day/night to help someone with an emergency at the hospital.
